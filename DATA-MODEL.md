...
Examples:
 `Workspace  ├── Links  ├── Domains  ├── QR Codes  ├── Integrations  ├── API Keys  └── Users `  
# 4. Link
...
Examples:
 `Actor  ── ACCESSED ──► Identity  Identity  ── RESOLVES_TO ──► Referent  Surface  ── PRESENTS ──► Identity  Campaign  ── PROMOTES ──► Referent  Interaction  ── ATTRIBUTED_TO ──► Campaign  Interaction  ── GENERATED ──► Outcome ` 
...
Reality IDs:
 `actor_xxxxx identity_xxxxx referent_xxxxx surface_xxxxx campaign_xxxxx interaction_xxxxx outcome_xxxxx ` 
