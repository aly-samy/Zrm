...
**Version:** v3.0 — Second Round Audit Implementation
...
# 2. Constitutional Editorial and Terminology Style Guide

This guide defines the mandatory capitalization and editorial rules for all Zyppi SDK documentation and specifications. Compliance with these rules ensures constitutional clarity and reduces ambiguity across different language implementations.

## 2.1 Mandatory Capitalization

- **Runtime Authority**: The governing entity responsible for the official Zyppi Runtime and Certification Registry.

The following terms SHALL be capitalized when referring to official Zyppi constitutional entities, processes, or artifacts:

- **Runtime**: The official Zyppi execution environment.
- **Constitution**: The body of rules governing the Zyppi ecosystem.
- **Certification**: The formal process of verifying an implementation against constitutional requirements.
- **Registry**: The official record of Certified SDKs and their status.
- **Extension**: A pluggable software component (as defined in Batch 12) that extends SDK or Runtime behavior through approved constitutional interfaces.
- **Corpus**: The collection of test data and scenarios used for Certification.
- **Suite**: The formal set of conformance tests.
- **SDK**: The software interface layer that translates constitutional Zyppi capabilities into language-native developer experiences while preserving behavioral equivalence.

Generic descriptive usage (e.g., "the runtime environment", "subclassing or inheritance") SHALL remain lowercase.

## 2.2 Editorial Principles

- **Active Voice**: Editorial revisions SHOULD prefer active voice whenever doing so improves readability without changing constitutional meaning.
- **Sentence Structure**: Unusually long sentences SHOULD be divided into smaller normative statements where practical.
- **Terminology Repetition**: Unnecessary repetition of constitutional terminology MAY be reduced where meaning remains unambiguous. However, repetition SHALL be retained whenever it reinforces legal precision or avoids interpretive ambiguity.
...
A **Certified Zyppi SDK** is any SDK that:
...
Certification status is determined through constitutional conformance—not organizational ownership.
...
# 6. SDK Specification Categories
...
# 6.1 SDK Design Philosophy (Informative)
...
# 6.2 SDK Behavioral Contract (Normative)
...
# 6.3 SDK Lifecycle Policies (Normative Governance)
...
## 7.4 Constitutional Transparency
...
## 7.5 Machine-First, Human-Friendly
...
For constitutional operations that cannot complete immediately, SDKs SHALL expose a stable execution handle (or equivalent language-native execution reference). This handle allows developers to observe eventual completion without changing constitutional semantics.

Representation is language-specific.

Behavior is universal.

# 8.7 Operation Categories
...
# 8.8 Retry Expectations

The Runtime exclusively determines retry eligibility.
...
# 8.10 Behavioral Consistency During Failure
...
# 8.11 Cross-Language Conformance
...
# 8.12 Long-Running Constitutional Operations
...
# 8.13 Batch Operation Contract

SDKs SHALL preserve behavioral equivalence for operations involving multiple Reality Claims (Batches).

## 8.13.1 Non-Atomic Defaults

SDKs SHALL NOT simulate atomicity for Batch operations unless the Runtime explicitly guarantees it.

## 8.13.2 Result Granularity

Mixed results from Batch operations MUST be exposed as a collection of individual admission receipts or errors. SDKs SHALL NOT throw a top-level exception for partial Batch failures unless no items in the batch were successfully admitted.

# 9. Operation Category Model
...
# 9.4 Category A — Read Operations
...
# 9.5 Category B — State-Changing Operations
...
# 9.6 Category C — Reasoning & Attestation Operations
...
# 9.12 Pending Intent Retention

SDKs SHALL strengthen business continuity guarantees for rejected Pending Intents.

## 9.12.1 Intent Retention
...
## 9.12.2 Retention Management

SDKs SHALL support:

- Configurable retention periods.
- Standardized rejection reason codes.
- Administrative query interfaces.
- Structured retry conditions.

## 9.12.3 Remediation

SDKs SHALL provide explicit remediation guidance based on standardized rejection codes provided by the Runtime.

# 9.13 Category Stability
...
## 10.4 Mandatory Error Structure
...
## 10.9 Machine-readable Diagnostics
...
## 10.13 Observability Integration
...
## 10.14 Certification Requirements
...
## 11.3 Session Lifecycle (Amended)
...
## 11.3.1 Session State Semantics (New)
...
## 11.10 Session Invalidation (Amended)
...
## 11.13 Session Recovery (Amended)
...
## 11.13.1 Runtime Session Expiration (New)
...
## 11.15 Certification Requirements (Amended)
...
# 11. Durable Audit Journaling

SDKs SHALL strengthen constitutional audit durability to ensure evidence survives SDK crashes and Extension failures.

## 11.1 Mandatory Journaling

SDKs SHALL implement mandatory pre-execution audit journaling.

## 11.2 Recovery Procedures

SDKs SHALL implement:

- Crash recovery procedures for interrupted operations.
- Recovery event reporting.
- Audit completion semantics.

## 11.3 Extension Execution Guard

SDKs SHALL produce durable minimum audit records BEFORE Extension execution. Constitutional audit evidence SHALL survive SDK crashes and Extension failures.

## 11.4 Tier 1 Requirements

Tier 1 Production Extensions SHALL utilize isolation mechanisms that guarantee no shared memory corruption and independent failure domains (Strict Operational Isolation).

# 13. Offline Constitutional Contract
...
# 13.3 Constitutional Offline Model
...
# 13.4 Offline Session Relationship
...
## 13.15 Constitutional Limitations
...
## 13.19 Certification Requirements
...
# Constitutional Snapshot Principle
...
## 14.8 Deterministic Diagnostics
...
## 14.10 Autonomous Execution Support
...
## 14.16 Human–Machine Equivalence
...
## 14.18 Certification Requirements
...
## 15.2.2 SDKs Never Manufacture Trust
...
## 15.2.3 Security Is Behavioral Before Cryptographic
...
## 15.2.4 Every Privileged Action Is Attributable
...
## 15.2.5 SDKs Expose Trust; They Never Interpret It
...
## 15.2.7 Identity Boundaries Are Absolute
...
## 15.2.8 Security Behavior Shall Be Deterministic
...
## 15.6.5 Identity Leakage Prevention
...
## 15.7.1 Runtime-Originated Trust
...
## 15.8.2 Transparent Transportation
...
## 15.9.5 Constitutional Trust During Offline Operation
...
## 15.11.1 Observable Security State
...
## 15.11.2 Observable Security Events
...
# 15.13 Certification Requirements
...
## 16.2.2 Constitutional Immutability
...
## 16.2.5 Trust Before Convenience
...
## 16.2.6 Human and Machine Equality
...
## 16.2.7 Constitutional Version Separation
...
## 16.3.5 Integration with Constitutional Specifications
...
## 16.3.6 Stability as Constitutional Trust
...
# 16.4 Stability Tier Definitions
...
## 16.4.1 Tier 1 — Production Constitutional
...
### 16.4.1.1 Enterprise LTS Mapping

SDK publishers SHALL expose a machine-readable LTS compatibility matrix (`lts_matrix`).

The `lts_matrix` artifact SHALL contain:
...
The Certification Registry SHALL expose this information through its machine-readable interface. Capability Discovery SHALL expose both SDK Version and Constitutional Compatibility Version, allowing enterprise tooling to determine support eligibility programmatically.


## 16.4.2 Tier 2 — Supported
...
Every lifecycle transition SHALL follow the published progression defined in Section 16.5.

## 16.4.7 Relationship with Operation Categories
...
## 16.5.3 Production Constitutional
...
## 16.5.6 Constitutional Promotion Criteria
...
# 16.6 Stability Guarantee Matrix
...
## 16.7.2 Semantic Versioning Integration
...
# 16.11 Breaking Change Policy

## 16.11.2 Emergency Security Amendments

In the event of critical security vulnerabilities verified by the AI Council, the 12-month mandatory migration window for Tier 1 capabilities MAY be reduced to 30 days. Emergency amendments SHALL include dedicated migration assistance from the Runtime Authority.
...
## Enterprise Maintenance Commitment
...
## Constitutional vs Operational Support
...
### 16.12.1 Security Maintenance During Long-Term Support

##.1 Security Continuity
...
Where a vulnerability cannot be mitigated without altering constitutional behavior, the resulting change SHALL follow the Breaking Change Policy defined in Section 16.11 and SHALL NOT be introduced as a routine security update.

##.4 Certification Preservation
...
Certification SHALL remain valid unless one of the constitutional re-Certification triggers defined in Section 16.13 is reached.
...
## Certification Stability Matrix
...
### 17.2.2 Constitutional Authority
...
### 17.2.3 Executable Specification Authority
...
### 17.2.4 Implementation Independence
...
### 17.2.5 Certification Independence
...
### 17.2.9 Historical Immutability
...
### 17.2.11 Equal Constitutional Treatment

Every SDK seeking Behavioral Certification (Constitutional Certification) SHALL be evaluated against identical constitutional requirements.
...
### 17.4.4 Constitutional Equivalence
...
### 17.5.2 Constitutional Authority
...
### 17.5.5 Constitutional Artifact
...
### 17.6.2 Constitutional Integrity
...
## 17.7 Canonical Reference Implementation
...
### 17.7.4 Implementation Independence
...
### 17.8.2 Constitutional Authority
...
### 17.8.5 Differential Verification
...
### 17.9.5 Deterministic Execution
...
### 17.10.4 Historical Preservation
...
## 17.11 Machine-Verifiable Certification
...
### 17.11.4 Cryptographic Attestation
...
### 17.12.3 Certification Decision
...
### 17.12.4 Certification Attestation
...
### 17.13.2 Mandatory Re-Certification
...
### 17.13.3 Non-Required Re-Certification
...
### 17.13.4 Certification Continuity
...
## 17.14 Certification Continuity During Long-Term Support
...
### 17.14.2 Constitutional Guarantee
...
## 17.15 Certification Revocation
...
### 17.15.2 Grounds for Revocation
...
### 17.14.2 Root Certification Authority
...
### 17.14.3 Delegated Certification Authorities
...
### 17.14.5 Authority Responsibilities
...
### 17.15.5 Historical Preservation
...
### 17.16.4 Certification Suite Versioning
...
### 17.16.5 Frozen Certification Corpus
...
## 20.2 Constitutional Extension Boundary
...
## 20.3 SDK Consumer vs Extension
...
## 20.5 Constitutional Extension Law
...
# 20.6 Approved Extension Surface
...
# 20.7 Approved Extension Points
...
## 20.7.1 Pre-Execution Extensions
...
## 20.7.2 Post-Execution Extensions
...
## 20.7.3 Observability Extensions
...
## 20.7.5 Developer Experience Extensions
...
## 20.7.6 AI Execution Extensions
...
# 20.8 Forbidden Extension Points
...
# 20.9 Extension Runtime Isolation
...
# 20.13 Extension Identity and Compatibility
...
-
**capability_class** SHALL correspond to one of the capability classes defined in Section 20.8.
...
## 20.13.1 Extension Compatibility Window
...
## 20.13.2 Extension Identity in Constitutional Telemetry
...
## 20.15.1 Operational Immunity

Certified SDKs SHALL maintain **Operational Immunity** as defined in Section 20.10. Extensions SHALL NOT compromise constitutional execution, corrupt state, or alter behavioral guarantees. The SDK remains the authoritative participant.

## 20.15.2 Compatibility Enforcement

SDKs SHALL NOT load Extensions whose Compatibility Window excludes the current SDK version. In the event of a dependency conflict between Extensions, the SDK SHALL prioritize constitutional stability and MAY refuse to load the conflicting Extensions, emitting a COMPLIANCE_ERROR.

## 20.15.3 Runtime Isolation

Certified SDKs SHALL isolate Extension execution from constitutional execution as defined in Section 20.9. Technical isolation mechanisms are implementation-specific, but constitutional guarantees remain mandatory.

# 20.16 Extension Failure Model

Extension failures are expected operational events.

They SHALL NOT become constitutional failures.

## 20.16.1 Failure Isolation
...
## 20.16.2 Deterministic Failure Handling
...
## 20.16.4 Constitutional Observability
...
# 20.18 Offline Extension Verification (Signed Attestation Model)

To preserve the Offline Constitutional Contract, Extensions SHALL carry a cryptographically signed attestation issued by the Certification Registry.

## 20.18.1 Local Verification

SDKs SHALL verify Extension attestations locally without requiring a network connection.

## 20.18.2 Attestation Lifecycle

The Runtime Authority SHALL define Attestation Time-To-Live (TTL) values. SDKs SHALL refresh attestations according to Registry policy whenever connectivity is established.

# 20.19 Constitutional Closure
...
# 21.2 Constitutional Performance Laws
...
## 21.2.1 Performance SHALL NEVER Compromise Correctness

A Certified SDK SHALL NEVER sacrifice correctness—as defined by the Constitution—for performance.
...
## 21.2.2 Behavioral Determinism Precedes Optimization
...
## 21.2.3 Optimization SHALL Preserve Constitutional Behavior
...
## 21.2.4 Caching SHALL NEVER Mutate Observable Behavior
...
## 21.2.5 Parallel Execution SHALL Preserve Determinism
...
Asynchronous execution SHALL preserve the completion guarantees defined in Section 8.12. Optimizations SHALL NOT alter observable completion ordering where such ordering forms part of the constitutional behavioral contract, nor introduce non-deterministic timing dependencies that affect constitutional outcomes.

## 21.2.6 Performance Is Subordinate to the Constitution
...
# 21.3 Constitutional Performance Obligations
...
## 21.3.1 Performance Degradation SHALL Be Observable
...
### 21.3.1.1 Offline Performance Transparency
...
## 21.3.2 Transparent Resource Management
...
## 21.3.3 Constitutional AI Execution Guarantees
...
Such strategies SHALL preserve the completion guarantees defined by Section 8.12.
...
## 21.3.5 Constitutional Execution Budget
...
## 21.4.1 Slow SHALL Never Mean Broken
...
## 21.4.2 Constitutional Diagnostic Transparency
...
## 21.5.2 Implementation Independence
...
## 21.5.3 Optimization Competition
...
# 22.1 Certified Ecosystem Model
...
## 22.1.1 Certified Ecosystem Model
...
## 22.1.2 Constitutional Trust Chain
...
## 22.2.1 Constitutional Position
...
## 22.2.4 Immutable Historical Record
...
## 22.2.5 Machine-Readable Registry
...
## 22.3.2 Compatible Community SDK
...
## 22.3.3 Certified Third-Party SDK
...
## 22.4.2 Marketplace Responsibilities
...
# 22.5 Development Environment Guarantee
...
## 22.5.2 Constitutional Equivalence
...
Given identical constitutional inputs, a Certified Mock Runtime SHALL produce externally observable constitutional behavior identical to the Production Runtime.
...
## 22.5.3 Operational Differences
...
## 22.5.5 Developer Trust Guarantee
...
## 22.6.2 Community Participation
...
Community participation SHALL NOT require governance approval from the Runtime Authority.
...
## 22.6.3 Community Responsibilities
...
## 22.6.4 Community Accountability
...
These concerns are governed by independent constitutional specifications or implementation-specific documentation.
...
# 23.2 SDK Constitutional Position
...
# 23.3 Relationship to Future Specifications
...
## 23.4.1 Constitutional Amendments
