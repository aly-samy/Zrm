...
**Version:** v2.0 — Constitutional Audit v1.1 Implementation
...
- **Extension**: A software component that extends SDK or Runtime behavior through approved interfaces.
- **Corpus**: The collection of test data and scenarios used for Certification.
- **Suite**: The formal set of conformance tests.
- **SDK**: Any official Zyppi Software Development Kit.

Generic descriptive usage (e.g., "the runtime environment", "extension of a class") SHALL remain lowercase.
...
Tier 1 Production Extensions SHALL additionally comply with out-of-process execution requirements to ensure operational immunity and audit durability.
