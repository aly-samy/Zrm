...
## Constitutional Hierarchy
 `Founding Principles         ↓ ZRM Constitution         ↓ Runtime Specifications         ↓ PLATFORM-SPEC-001         ↓ SDK-SPEC-001         ↓ Official SDK Implementations (TypeScript • Python • Java • Swift • Rust • .NET • Go • ...) ` 
...
Security, credentials, identity and attestation exposure
 
 
 
POL-001
 
Policy evaluation and authorization behavior
 
 
 
FED-001
 
Federation and cross-boundary trust behavior
 
 
 
SDK-SPEC-001
 
Language interface behavior
