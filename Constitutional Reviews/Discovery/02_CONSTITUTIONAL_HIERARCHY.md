...
- **-_Purchase_Contract**: WS-03A.5 — CL-07 Intent Contract Constitutional Governance Frame (./constitution/ratified/WS-03A.5.md)
...
- **-_Actor_parent_of_Referent**: WS-03C — Cross-Cluster Relationship Matrix Constitution (./constitution/ratified/WS-03C.md)
- **Employment_Contract**: WS-03D Amendment — Authority Anchor Model (./constitution/ratified/WS-03D.md)
